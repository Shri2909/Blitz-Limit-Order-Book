 ...
 *
 * HYDRA-LOB note: vendored from the xdp-tutorial project's
 * common/parsing_helpers.h (https://github.com/xdp-project/xdp-tutorial),
 * unmodified, so net/xdp_prog.bpf.c is self-contained and has no dependency
 * on that repository being checked out alongside this one.
 */
